...
$(document).ready(function () {
  ...
  // sidebar 새로고침해도 계속 열려있는 js
  $(".pcoded-hasmenu").each(function(idx,el){
    if($(el).hasClass("pcoded-trigger")){
      $(el).children(".pcoded-submenu").show();
    }
  });
...
// $("body").append(
//   '<div class="fixed-button active"><a href="https://1.envato.market/PgJNQ" target="_blank" class="btn btn-md btn-primary"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Upgrade To Pro</a> </div>'
// );
